  ...
  <body>
    <div class="app" id="app">
      ...
      <div id="aside" class="app-aside modal fade nav-dropdown">
        <!-- fluid app aside -->
        <div class="left navside teal-A700 dk" layout="column">
          ...
          <div flex class="hide-scroll">
            <nav class="scroll nav-light" style="color: black;">
              ...
              <ul class="nav" ui-nav>
                ...
                <li class='<?= (sidebar($sidebar, ['phonebook'])) ? 'active' : '' ?>'>
                  <a href="<?= base_url() ?>phonebook">
                    <span class="nav-icon">
                      <i class="fa fa-book">
                      </i>
                    </span>
                    <span class="nav-text"> Phonebook </span>
                  </a>
                </li>
              </ul>
            </nav>
