...
var load_contacts = () => {
    $(document).gmLoadPage({
       url: baseUrl + 'phonebook/get_contacts',
 ...
 $(document).ready(function () {
                ...
                buttons: {
                    ...
                    okay: {
                        ...
                        action: function () {
                                ...
                                $.ajax({
                                    url: 'phonebook/service/Phonebook_service/save',
                ...
                okay: {
                    ...
                    action: function () {
                        $(document).gmPostHandler({
                            url: 'phonebook/service/Phonebook_service/delete',
                            selector: '.form-control',
                            data: {
                            ID: id,
                            },
        ...
        $.confirm({
            ...
            buttons: {
                ...
                okay: {
                    ...
                    action: function () {
                        $(document).gmPostHandler({
                            url: 'phonebook/service/Phonebook_service/update',
                            selector: '.form-control',
                            data: {
                                ID             : $('#ID').val(),
                                Fname          : $('#Fname').val(),
    ...
    $(document).on('click', '#search', function () {
        $(document).gmLoadPage({
            url: 'phonebook/service/Phonebook_service/search',
            data: {
